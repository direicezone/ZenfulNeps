...
namespace ZenfulNeps.Controllers
{
    public class ZenfulNepsController : Controller
    {
        public List<RawRssInfo> rawRssInfoList = new List<RawRssInfo>
        {
            ...
            new RawRssInfo{ RssLink = "http://feeds.tasteofhome.com/taste-of-home/lower-fat-recipes/", RssHeading = "Taste of Home - Lower Fat Recipe" },
            new RawRssInfo{ RssLink = "http://www.history.com/this-day-in-history/rss", RssHeading = "Today in History" },
            new RawRssInfo{ RssLink = "http://beersmith.com/blog/feed/", RssHeading = "BeerSmith™ Home Brewing Blog", RssHost = "beersmith.com" },
        };
